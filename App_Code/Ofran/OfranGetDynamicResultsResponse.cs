...
public class OfranGetDynamicResultsResponse
{
    ...
    public class Contract
    {
        ...
        [XmlElement(ElementName = "Supplierpicturefile")]
        public string Supplierpicturefile { get; set; }
...
public class OfranAdditionalProduct
{
